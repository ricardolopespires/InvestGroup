    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symbol', models.CharField(default='symbol', max_length=40)),
                ...
                ('continent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='secao_indices', to='economia.continent')),
            ],
        ),
        migrations.CreateModel(
            name='Currencie',
