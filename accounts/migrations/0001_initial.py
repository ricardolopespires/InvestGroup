# Generated by Django 4.0.5 on 2022-10-23 18:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_investidor', models.CharField(blank=True, max_length=150)),
                ('is_staff', models.BooleanField(blank=True, default=False, verbose_name='É da equipe?')),
                ('perfil', models.BooleanField(blank=True, default=False, verbose_name='Já fez perfil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(max_length=190, primary_key=True, serialize=False, unique=True)),
                ('title', models.CharField(help_text='A Perguntas do questionario', max_length=150)),
                ('usuarios', models.ManyToManyField(blank=True, related_name='usuarios_questionare', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questionnaire', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questionario', to='accounts.questionnaire')),
            ],
            options={
