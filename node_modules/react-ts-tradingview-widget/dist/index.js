        ...
        if (type === "Widget" || type === "MediumWidget") {
          script_1.onload = function () {
            if (typeof TradingView !== undefined) {
              script_1.innerHTML = JSON.stringify(
                type === "Widget"
              ...
              __assign(
                __assign(
                  __assign(
                    __assign(
                      {},
                      !autosize ? { width: width } : { width: "100%" }
                    ),
                    !autosize ? { height: height } : { height: "100%" }
                  ),
                  { autosize: autosize, symbol: symbol }
                ),
                !range ? { interval: interval } : { range: range }
              ),
              {
                timezone: timezone,
                theme: theme,
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(Widget, {
      scriptHTML: __assign(
        __assign(
          __assign(
            __assign({}, !autosize ? { width: width } : { width: "100%" }),
            !autosize ? { height: height } : { height: "100%" }
          ),
          {
            symbol: symbol,
...
var EconomicCalendar = function (_a) {
  var _b = _a.colorTheme,
    ...
    _j = _a.currencyFilter,
    currencyFilter = _j === void 0 ? undefined : _j,
    props = __rest(_a, [
      "colorTheme",
      "isTransparent",
      "width",
    ...
    React__default["default"].createElement(Widget, {
      scriptHTML: __assign(
        __assign(
          __assign(
            __assign(
              { colorTheme: colorTheme, isTransparent: isTransparent },
              !autosize ? { width: width } : { width: "100%" }
            ),
            !autosize ? { height: height } : { height: "100%" }
          ),
...
var MarketOverview = function (_a) {
  var _b = _a.colorTheme,
    ...
    belowLineFillColorGrowingBottom =
      _u === void 0 ? "rgba(41, 98, 255, 0)" : _u,
    _v = _a.belowLineFillColorFallingBottom,
    belowLineFillColorFallingBottom =
      _v === void 0 ? "rgba(41, 98, 255, 0)" : _v,
            ...
            __assign(
              __assign(
                __assign(
                  __assign(
                    __assign(
                      __assign(
                        __assign(
                          __assign(
                            { symbols: symbols, chartOnly: chartOnly },
                            !autosize ? { width: width } : { width: "100%" }
                          ),
                          !autosize ? { height: height } : { height: "100%" }
                        ),
                  ...
                  chartType === "line" && { lineColor: lineColor }
                ),
                chartType === "area" && {
                  lineColor: lineColor,
