...
import ManagementRealStateActive from '@/components/ManagementRealStateActive'
...
const Page = () => {
  ...
  return (
        <div className='absolute inset-x-0 top-[140px]  px-20  h-screen'>
            ...
            <img className="h-10 w-10  object-cover" src="/RealState.png" alt="profile" />
            </div>
            <h1 className='text-2xl text-white'>Fundo Imobiliários</h1>
            </div>
            <p className='text-gray-500 mt-2'>O gerenciamento de portfólio de <span className='text-amber-400'> Fundo Imobiliários </span> com objetivo de atingir metas específicas.</p>
            </div>
            <div className='flex items-center justify-between w-full'>
                <a href="/settings" className="mt-10 flex items-center text-white mr-5 hover:text-amber-400 text-4xl font-semibold ">     
                <FaReplyAll />     
                </a>
                <ManagementRealStateActive AccountId={undefined}/>
           </div>
