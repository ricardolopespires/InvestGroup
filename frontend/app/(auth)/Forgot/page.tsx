...
import { userResetPassword } from "@/lib/atcions/actions.user";
...
const Page = () => {
  ...
  return (
    <div className="flex w-full h-screen inset-0 items-center justify-center">      
        <Card className="w-[600px] h-[320px] rounded ">
            <CardHeader>
                <CardTitle className='flex items-center justify-center mb-4 cursor-pointer'>
                Esqueceu sua senha?
                </CardTitle>
                <CardDescription className="text-xs">Digite seu endereço de e-mail, enviaremos um link para redefinir sua senha!</CardDescription>
            </CardHeader>
            <CardContent>
            <Form {...form}>
            ...
            <CardFooter className=" flex flex-col space-y-4 w-full">           
              <div className="flex items-center justify-between w-full text-xs">
                  <a className="text-indigo-700 hover:text-pink-700 float-left" href="/Sign-In"><span className="text-gray-400">Lembrou a senha?</span> login </a>                
              </div>
            </CardFooter>
        </Card>
