        ...
        <div className="mb-6 rounded-lg bg-white p-6 shadow w-full border">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <img className="mr-2 h-10 w-10  object-cover" src="https://public.bnbstatic.com/20190405/eb2349c3-b2f8-4a93-a286-8f86a62ea9d8.png" alt="profile" />
                  <div>
                    <h3 className="text-base font-semibold text-gray-900">Binance</h3>
                    <span className="block text-xs font-normal text-gray-500">Exchange</span>
                  </div>
                </div>
